                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-4">
                            <form action="update-profile.php" method="post">
                                ...
                                <br>
                                <input type="text" name="nama" value="" placeholder="<?= $_SESSION['nama']; ?>">
                                <br>
                                <fieldset disabled="disabled">
                                    <label for="NPM">NPM</label>
                                    <br>
                                    <input type="text" name="NPM" value="G1A020095" placeholder="NPM [wip-feature]">
                                    <br>
                                    <label for="email">Email</label>
                                    <br>
                                    <input type="text" name="email" value="willdhan354@gmail.com" placeholder="Email [wip-feature]">
                                    <br>
                                    <label for="password">Password</label>
                                    <br>
                                    <input type="password" name="password" value="belajarphpnative" placeholder="Password [wip-feature]">
                                    <br>
                                </fieldset>
                                <br>
